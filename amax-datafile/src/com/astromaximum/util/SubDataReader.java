...
public abstract class SubDataReader {
	...
	protected int read(DataInputStream is, int evtype, int planet, boolean isCommon,
			long dayStart, long dayEnd, long mFinalJD) {
		try {
			is.reset();
		} catch (IOException e) {
